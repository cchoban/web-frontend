      ...
      <div class="ui column posts post-content">
        <div
          ...
          <div class="header-section">
            ...
            <div class="title">
              <h2>
                <router-link :to="`/${pack.packageName}`">{{ pack.packageName }}</router-link>
              </h2>
            </div>
            <div class="author">
              ...
              <a
                href="#"
                class="author-name"> {{ pack.user_name }} </a>
              <span class="bold time"> <timeago :datetime="pack.updated_at"/> </span>
            </div>
          </div>
